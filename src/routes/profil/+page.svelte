<div class="relative flex flex-col w-full min-h-screen bg-white">
    ...
    <div class="py-4">
        <div class="flex items-center w-full px-5 space-x-5">
            <img
                alt="user"
                class="rounded-3xl bg-gray-100 w-20"
    ...
    <hr class="border-4 border-gray-100" />
    <div class="py-4">
        <ul>
            <li>
                <button
    ...
    <div class="px-5 mt-20">
        <button
            type="submit"
            class="flex w-full items-center justify-center px-8 py-5 rounded-3xl active:bg-opacity-80 disabled:bg-opacity-40 disabled:text-opacity-50 bg-gradient-to-br from-blue-400 to-blue-600 text-white"
        >
            <!---->Logout
        </button>
    </div>
