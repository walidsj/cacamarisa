...
<div class="relative flex flex-col w-full min-h-screen">
    ...
    <main class="flex min-h-[75vh]">
        <form
            ...
            class="flex flex-col justify-center min-w-full px-6 space-y-6"
        >
            ...
            <div class="mt-20 w-full">
                <button
                    type="submit"
                    class="flex gap-2 w-full items-center justify-center px-8 py-5 rounded-3xl active:bg-opacity-80 disabled:bg-opacity-40 disabled:text-opacity-50 bg-blue-500 text-white"
                >
                    <svg
                        class="h-6 w-6"
                        stroke="currentColor"
