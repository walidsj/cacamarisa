    ...
    >
        <header class="flex flex-row justify-between py-1 pt-5 px-5">
            ...
            <div class="inline-flex">
                ...
                >
                    <svg class="w-7 h-7 text-gray-400" viewBox="0 0 512 512">
                        <path
    ...
    >
        <div class="flex justify-around">
            <a href="/" class="flex flex-col items-center justify-center">
                <svg class="w-8 h-8 text-blue-500" viewBox="0 0 512 512">
                    <path
                        d="M80 212v236a16 16 0 0016 16h96V328a24 24 0 0124-24h80a24 24 0 0124 24v136h96a16 16 0 0016-16V212"
                        fill={$page.url.pathname == '/'
                            ? 'currentColor'
                            : 'none'}
                        stroke="currentColor"
                        stroke-linecap="round"
            ...
            <div>
                ...
                >
                    <svg class="w-8 h-8 text-white" viewBox="0 0 512 512">
                        <path
